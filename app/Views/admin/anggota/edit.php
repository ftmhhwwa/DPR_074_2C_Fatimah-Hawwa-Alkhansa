    ...
    <form action="/admin/anggota/update/<?= $anggota['id_anggota'] ?>" method="post">
        ...
        <div class="form-group">
            ...
            <select id="status_pernikahan" name="status_pernikahan" class="form-control" required>
                ...
                <option value="cerai_hidup" <?= $anggota['status_pernikahan'] === 'cerai_hidup' ? 'selected' : '' ?>>Cerai Hidup</option>
                <option value="cerai_mati" <?= $anggota['status_pernikahan'] === 'cerai_mati' ? 'selected' : '' ?>>Cerai Mati</option>
            </select>
        </div>
